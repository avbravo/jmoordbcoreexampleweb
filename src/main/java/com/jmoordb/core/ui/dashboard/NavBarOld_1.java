...
public class NavBarOld_1 implements WebComponent {
    ...
    public NavBarOld_1(String username, HttpServletRequest request, Boolean showNotification,Integer notificationCount ) {
