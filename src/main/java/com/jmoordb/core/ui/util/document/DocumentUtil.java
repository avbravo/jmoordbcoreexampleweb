 ...
 */
package com.jmoordb.core.ui.util.document;

import com.jmoordb.core.ui.util.DateUtil;
import static com.jmoordb.core.ui.util.DateUtil.setHourToDate;
...
//            BsonDocument asBsonDocument =filter.toBsonDocument(BsonDocument.class,  MongoClient.getDefaultCodecRegistry());
    ...
    public static Document sortBuilder(HashMap<String, String> map) {
        ...
        try {
            ...
            JettraUIUtil.errorMessage(JettraUIUtil.nameOfClassAndMethod() + "error: " + e.getLocalizedMessage());
        }
        return sort;
    }
    // </editor-fold>
        ...
        try {
            ...
            switch (fieldtype) {
                ...
                case "string":
                    ...
                    break;
                case "date":
                    filter = Filters.eq(fieldname, DateUtil.stringToISODate(value));
                case "boolean":
    ...
    public static Bson createBsonBetweenDateWithoutHoursIsoDate(String fieldnamestart, Date datestartvalue, String fieldlimitname, Date datelimitvalue) {
        ...
        try {
            ...
            dateStart = DateUtil.stringToISODate(DateUtil.isoDateToString(dateStart));

            Date dateEnd = setHourToDate(datelimitvalue, 23, 59);
            dateEnd = DateUtil.stringToISODate(DateUtil.isoDateToString(dateEnd));
