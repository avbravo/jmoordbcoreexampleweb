 ...
 */
package com.jmoordb.core.ui.util;
// <editor-fold defaultstate="collapsed" desc="import">  

import static com.jmoordb.core.ui.util.JettraUIUtil.errorDialog;
import static com.jmoordb.core.ui.util.JettraUIUtil.errorMessage;
import com.jmoordb.core.ui.util.date.DecomposedDate;
import com.jmoordb.core.ui.util.date.FechaDiaUtils;
import com.jmoordb.core.ui.util.date.Tiempo;
...
// <editor-fold defaultstate="collapsed" desc="fechaHoraActual()"> 
    ...
    public static String hourFromDateToString(Date fecha, String... format) {
        ...
        try {
            ...
            JettraUIUtil.errorMessage("hourFromDateToString() " + e.getLocalizedMessage());
        }
        return h;
...
// </editor-fold>
    ...
    public static Boolean isValidCierreMensual(Integer anioselected, String messelected, Integer diaminimo, ResourceBundle rs) {
        try {
            ...
            if (anioselected <= 0) {
                JettraUIUtil.warningMessage(rs.getString("warning.anionegativo"));
                return false;
            }
            if (anioselected > getAnioActual()) {
                JettraUIUtil.warningMessage(rs.getString("warning.anomayorqueactual"));
                return false;
            }

            Integer anio = getAnioActual() - anioselected;
            if (anio.intValue() > 1) {
                JettraUIUtil.warningMessage(rs.getString("warning.aniomuyantiguo"));
                return false;
            }
            if (anio.intValue() == 1 && !messelected.toLowerCase().equals("diciembre")) {
                JettraUIUtil.warningMessage(rs.getString("warning.debecerrardiciembredelañoanterior"));
                return false;
            }
            ...
            if (numeromesseleccionado > mesactual) {
                JettraUIUtil.warningMessage(rs.getString("warning.mesacerrarmayoractual"));
                return false;
            }
            if (numeromesseleccionado.equals(mesactual) && diaactual < diaminimo) {
                JettraUIUtil.warningMessage(rs.getString("warning.estacerrandoelmesmuypronto"));
                return false;
            }
            return true;
        } catch (Exception e) {
            JettraUIUtil.warningMessage("isValidCierreMensual" + e.getLocalizedMessage());
        }
        return false;
    }
...
//convertir la fecha de solicitud a LocalDate
    ...
    public static String showDate(Date date) {
        ...
        try {
            ...
            JettraUIUtil.errorMessage("showDate() " + e.getLocalizedMessage());
        }
        return h;
    }// </editor-fold>
    ...
    public String showDateLocalDate(LocalDate date) {
        ...
        try {
            ...
            JettraUIUtil.errorMessage("showDateLocalDate()" + e.getLocalizedMessage());
        }
    ...
    public static String showHour(Date date) {
        ...
        try {
            ...
            JettraUIUtil.errorMessage("showHour() " + e.getLocalizedMessage());
        }
        return h;
    }// </editor-fold>
